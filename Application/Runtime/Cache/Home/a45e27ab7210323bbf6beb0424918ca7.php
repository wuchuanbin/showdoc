...
<html lang="en">
  ...
  <body>
<link rel="stylesheet" href="/apidoc/Public/css/item/show.css" />
...
<div class="doc-body row">
  <!-- 左侧栏菜单 -->
    <div class="doc-left span3 bs-docs-sidebar pull-left">
      ...
      <input type="hidden" id="base_url" value="/apidoc/index.php">


    </div>
    <div class="doc-right  span10 ">
      <!-- 编辑栏 -->
...
<script src="/apidoc/Public/js/item/show.js"></script>